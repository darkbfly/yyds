...
exports.H5ST = exports.getH5ST = void 0;
...
var H5ST = /** @class */ (function () {
    ...
    H5ST.prototype.__genKey = function (tk, fp, ts, ai, algo) {
        var str = "".concat(tk, " ").concat(fp, " ").concat(ts, " ").concat(ai, " $ { this.rd }\n    ");
    ...
    H5ST.prototype.__genH5st = function (body) {
        ...
        return encodeURIComponent("".concat(this.timestamp, "; ").concat(this.fp, "; ").concat(this.appId.toString(), "; ").concat(this.tk, "; ").concat(s, "; 3.0; $ { this.time.toString() }"));
    };
    return H5ST;
}());
exports.H5ST = H5ST;
function getH5ST(fn, body, appid, fp, ua) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.post('https://sharecodepool.cnmb.win/api/h5st', { fn: fn, body: body, appid: appid, fp: fp, ua: ua })];
                case 1:
                    data = (_a.sent()).data;
