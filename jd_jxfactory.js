...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://cdn.jsdelivr.net/gh/1277002811/JDbot@master/shareCodes/jd_updateFactoryTuanId.json")
...
function updateTuanIdsCDN(url = 'https://cdn.jsdelivr.net/gh/1277002811/JDbot@master/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    $.get({url,
      timeout: 200000,
      headers:{
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/1277002811/JDbot@master/shareCodes/jd_updateFactoryTuanId.json');
